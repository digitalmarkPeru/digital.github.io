...
<body>
  <div class="wrap">
    ...
    <div class="grid">
      ...
      <div class="card">
        <h2 style="margin:0 0 10px;font-size:16px">Tienda</h2>
        <div class="shop">
          <div class="item">
            <div class="left">
  ...
  <script>
    // Estado (persistente)
    const LS_KEY = "arena_aritmetica_v1";
    const state = {
      lvl: 1,
      xp: 0,
      coins: 0,
    ...
    ui.buyDouble.addEventListener("click", ()=>{
      buy(30, ()=>{
        ...
        logLine("Compró doble XP.", "TIENDA");
      });
    });
